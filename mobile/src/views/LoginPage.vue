...
const login = async () => {
    ...
    try {
        var url = 'https://nice-water-05b1c7800.5.azurestaticapps.net/api/surveys';
            ...
            <div class="col-md-6">
                ...
                <form @submit.prevent="login">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" v-model="credentials.password" class="form-control" id="loginPassword"
                            required>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <form @submit.prevent="register">
                    <div class="mb-3">
                        ...
                        <input type="text" v-model="registrationData.firstName" class="form-control" id="firstName"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="lastName" class="form-label">Last Name</label>
                        <input type="text" v-model="registrationData.lastName" class="form-control" id="lastName"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="registerEmail" class="form-label">Email address</label>
                        <input type="email" v-model="registrationData.email" class="form-control" id="registerEmail"
                            required>
                    </div>
                    <div class="mb-3">
